...
const SignUp = ({ navigation }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Picker style={[styles.input, { marginLeft: 2, width: 330, marginBottom: -2, marginTop: -10 }]}
      ...
      <TouchableOpacity style={styles.login_button} onPress={handleSignUp}><Text>Sign Up</Text></TouchableOpacity>
